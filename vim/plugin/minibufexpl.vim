...
autocmd MiniBufExplorer VimEnter    * call <SID>DEBUG('-=> VimEnter  AutoCmd', 10) |call <SID>AutoUpdate(-1)
" }}}
...
function! <SID>StartExplorer(sticky, delBufNum)
  ...
  " Added to allow opening a buffer in a vertical split
...
function! <SID>AutoUpdate(delBufNum)
  ...
  if g:miniBufExplorerAutoUpdate == 1
    ...
    if ((g:miniBufExplorerMoreThanOne == 0) || (bufnr('%') != -1 && bufname('%') != ""))
	  ...
	  if g:miniBufExplForceSyntaxEnable == 1
...
"
function! <SID>MBESelectBuffer(vertical)
  call <SID>DEBUG('===========================',10)
...
"=============================================================================
" }}}
" vim:ft=vim:fdm=marker:ff=unix:tabstop=4:shiftwidth=4:softtabstop=4:smarttab:shiftround:expandtab
